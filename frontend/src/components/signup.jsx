...
const Signup = () => {
  ...
  const RandomUsername = () => {
    const prefix = [
      ...
      "Sunny", "Lucky", "Mighty", "Clever", "Free", "Wild", "Swift", "Bright", "Silver", "Golden", "Diamond",
      "Emerald", "Ruby", "Sapphire", "Blue", "Red", "Green", "Yellow", "Purple", "Orange", "Pink", "White",
      "Black", "Gray", "Neon", "Pixel", "Digital", "Cyber", "Nano", "Macro", "Micro", "Virtual", "Dream",
      "Cosmic", "Fusion", "Nuclear", "Quantum", "Alpha", "Omega", "Infinity", "Eternal", "Magical", "Mystic",
      "Fantastic",
    ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.error) {
        ...
        setFormData({
          username: "", // Reset only the username
          email: "",
          password: "",
        });
