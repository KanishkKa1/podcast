            ...
            <div className='flex justify-center items-center '>
                <div className='flex justify-center items-center w-4/5 p-5 rounded-3xl' style={{
                    ...
                    <div className="mx-auto w-2/5 grid grid-cols-1 gap-4">
                        <div className=" p-4">
                            <form action="https://formspree.io/samosamalhotra@gmail.com" method="POST">
                                <label htmlFor="email" className="block mb-2">Email:</label>
                                <input type="email" id="email" name="_replyto" className="w-full p-2 mb-4 border-black border-2 rounded-md" placeholder="Enter your email" />
                                ...
                                <textarea id="feedback" name="message" rows="4" className="w-full p-2 mb-4 border-black border-2 rounded-md" placeholder="Enter your feedback"></textarea>

                                <button type="submit" className='bg-black p-4 text-white hover:bg-yellow-400 rounded-full'>Send Message</button>
                            </form>
                        </div>
                    </div>
